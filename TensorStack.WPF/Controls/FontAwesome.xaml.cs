...
namespace TensorStack.WPF.Controls
{
    ...
    public partial class FontAwesome : BaseControl
    {
        ...
        public static readonly DependencyProperty SizeProperty =
            DependencyProperty.Register(nameof(Size), typeof(int), typeof(FontAwesome), new PropertyMetadata(16));

        public static readonly DependencyProperty IconProperty =
            DependencyProperty.Register(nameof(Icon), typeof(string), typeof(FontAwesome), new PropertyMetadata("\uf004"));

        public static readonly DependencyProperty ColorProperty =
            DependencyProperty.Register(nameof(Color), typeof(Brush), typeof(FontAwesome), new PropertyMetadata(Brushes.Black));

        public static readonly DependencyProperty IconStyleProperty =
            DependencyProperty.Register(nameof(IconStyle), typeof(FontAwesomeIconStyle), typeof(FontAwesome), new PropertyMetadata(FontAwesomeIconStyle.SharpLight));

        public static readonly DependencyProperty IsSpinnerProperty =
            DependencyProperty.Register(nameof(IsSpinner), typeof(bool), typeof(FontAwesome) , new PropertyMetadata((d, e) => { if (d is FontAwesome control) control.OnIsSpinnerChanged(); }));
