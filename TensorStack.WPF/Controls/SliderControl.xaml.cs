...
namespace TensorStack.WPF.Controls
{
    ...
    public partial class SliderControl : BaseControl
    {
        ...
        public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register(nameof(Maximum), typeof(double), typeof(SliderControl), new PropertyMetadata<SliderControl>((c) => c.OnValueChanged()));
        public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register(nameof(Minimum), typeof(double), typeof(SliderControl), new PropertyMetadata<SliderControl>((c) => c.OnValueChanged()));
        ...
        public bool IsPercent
        {
            ...
            set { SetProperty(ref _isPercent, value); UpdateValueText(); }
        }
