...
{
    public class StableDiffusion3Pipeline : PipelineBase, IPipeline<ImageTensor, GenerateOptions, GenerateProgress>
    {
        /// <summary>
        ...
        public StableDiffusion3Pipeline(TransformerSD3Model transformer, CLIPTokenizer tokenizer, CLIPTokenizer tokenizer2, T5Tokenizer tokenizer3, CLIPTextModel textEncoder, CLIPTextModelWithProjection textEncoder2, T5EncoderModel textEncoder3, AutoEncoderModel autoEncoder, ILogger logger = default) : base(logger)
        {
        ...
        /// <param name="logger">The logger.</param>
        public StableDiffusion3Pipeline(StableDiffusion3Config configuration, ILogger logger = default) : this(
