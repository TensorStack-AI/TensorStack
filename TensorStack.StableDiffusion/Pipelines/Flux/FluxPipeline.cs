...
{
    public class FluxPipeline : PipelineBase, IPipeline<ImageTensor, GenerateOptions, GenerateProgress>
    {
        /// <summary>
        ...
        public FluxPipeline(TransformerFluxModel transformer, CLIPTokenizer tokenizer, T5Tokenizer tokenizer2, CLIPTextModel textEncoder, T5EncoderModel textEncoder2, AutoEncoderModel autoEncoder, ILogger logger = default) : base(logger)
        {
        ...
        /// <param name="logger">The logger.</param>
        public FluxPipeline(FluxConfig configuration, ILogger logger = default) : this(
