...
{
    public sealed record DPMSolverSDEOptions : SchedulerOptions
    {
        public DPMSolverSDEOptions() : base() { }
        private DPMSolverSDEOptions(DPMSolverSDEOptions other) : base(other)
        {
        ...
        [JsonIgnore]
        public override SchedulerType Scheduler => SchedulerType.DPMSolverSDE;
        ...
        [JsonPropertyName("noise_sampler_seed")]
        public int? NoiseSamplerSeed { get; init; } = null;
