...
{
    public sealed record LMSOptions : SchedulerOptions
    {
        public LMSOptions() : base() { }
        private LMSOptions(LMSOptions other) : base(other)
        {
        ...
        [JsonIgnore]
        public override SchedulerType Scheduler => SchedulerType.LMS;
