...
{
    public sealed record DPMSolverSinglestepOptions : SchedulerOptions
    {
        public DPMSolverSinglestepOptions() : base() { }
        private DPMSolverSinglestepOptions(DPMSolverSinglestepOptions other) : base(other)
        {
        ...
        [JsonIgnore]
        public override SchedulerType Scheduler => SchedulerType.DPMSolverSinglestep;
        ...
        public bool LowerOrderFinal { get; set; } = false;
        ...
        public VarianceType? VarianceType { get; init; } = null;
