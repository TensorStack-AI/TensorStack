...
{
    public sealed record LCMOptions : SchedulerOptions
    {
        public LCMOptions() : base() { }
        private LCMOptions(LCMOptions other) : base(other)
        {
        ...
        [JsonIgnore]
        public override SchedulerType Scheduler => SchedulerType.LCM;
