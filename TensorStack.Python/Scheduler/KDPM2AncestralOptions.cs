...
{
    public sealed record KDPM2AncestralOptions : SchedulerOptions
    {
        public KDPM2AncestralOptions() : base() { }
        private KDPM2AncestralOptions(KDPM2AncestralOptions other) : base(other)
        {
        ...
        [JsonIgnore]
        public override SchedulerType Scheduler => SchedulerType.KDPM2Ancestral;
