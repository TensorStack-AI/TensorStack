...
namespace TensorStack.Florence.Processing
{
    public class PreProcessor
    {
        ...
        public PromptResult Process(GenerateOptions options)
        {
            var pixelValues = CLIPImage.Process(options.Image, _clipFeatureOptions);
            ...
            return new PromptResult(prompt, pixelValues);
        }
