...
namespace TensorStack.Transformers.Processing
{
    public sealed class KVCacheDecoder : IKVCache
    {
        ...
        public KVCacheDecoder(OrtType dataType, int numHeads, int numLayers, int hiddenSize)
        {
            _dataType = dataType;
            _numHeads = numHeads;
        ...
        private KVCacheDecoder(OrtType dataType, int numHeads, int numLayers, int hiddenSize, OrtValue[] values)
        ...
        public void Initialize(int initialSize)
        {
            ...
            var dimensions = new[] { 1L, _numHeads, 1, (_hiddenSize / _numHeads) };
        ...
        public IKVCache Clone()
        {
            ...
            return new KVCacheDecoder(_dataType, _numHeads, _numLayers, _hiddenSize, cacheValues);
        }
